  ...
  return (
    <main className="relative mx-auto flex min-h-screen max-w-4xl flex-col justify-center px-6 py-16 md:px-12">
      ...
      <div className="mb-8 text-left">
        <p className="text-xs uppercase tracking-[0.28em] text-[#92ff6f]">Sign in</p>
        <h1 className="mt-2 text-4xl font-semibold text-white sm:text-5xl">
          Sign in
        </h1>
        <p className="mt-3 max-w-2xl text-base text-white/70">
          Drop your email. We&apos;ll send you a one-time link.
        </p>
      </div>
        ...
        <CardContent>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button variant="outline" size="lg" type="button" onClick={() => router.push("/signup")}>
                Create account
              </Button>
            </div>
